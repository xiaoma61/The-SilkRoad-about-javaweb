...
<script src="<%=path %>/js/findname.js"type="text/javascript"></script>
...
<div class="header">&nbsp;&nbsp;&nbsp;<a href="<%=path %>/index.jsp" target="_blank"><font color="bule">首页 </font></a>&nbsp;>&nbsp;探索&nbsp;>&nbsp;陆上文物</div>
</div>
...
<div class="search1" style="color:black; ">
<jsp:useBean id="landroaddata" scope="session" class="cn.theslikeroad.dataPrepare.Thelandroad"/>
<% ArrayList list= (ArrayList)landroaddata.GetData();
int rows=list.size();
...
<h4><font color="#e14d1d63">一共有：<%=rows %>条记录 共<%=pages-1%>页</font></h4>
...
<%if(currentpage>1){ %>
<%if(currentpage==2){%>
<a href="<%=path %>/html/Land%20Slik%20Road.jsp" rel="external nofollow" rel="external nofollow" rel="external nofollow" rel="external nofollow" rel="external nofollow" rel="external nofollow"  ><span>上一页</span></a>
<%}else {%>
<a href="<%=path %>/html/Land%20Slik%20Road.jsp?page=<%=currentpage-1 %>" rel="external nofollow" rel="external nofollow" rel="external nofollow" rel="external nofollow" rel="external nofollow" rel="external nofollow"  ><span>上一页</span></a>
<%} }%>
 
<% if(currentpage<=5){ 
for(int i=1;i<=10&i<pages;i++)
{ 
%>

 <%if(i==currentpage){ %>
 <a href="<%=path %>/html/Land%20Slik%20Road.jsp?page=<%=currentpage%>" rel="external nofollow" rel="external nofollow" rel="external nofollow" rel="external nofollow" rel="external nofollow" rel="external nofollow" class="selected"><span><%=currentpage%></span></a>
 <%
 }else{%>
 <a href="<%=path %>/html/Land%20Slik%20Road.jsp?page=<%=i%>"  rel="external nofollow" rel="external nofollow" rel="external nofollow" rel="external nofollow" rel="external nofollow" ><span><%=i%></span></a>
 
 <%} %>
<%}
}else if(currentpage>=pages-5&&(pages-5)>0) {
 %>

 <%for(int i=currentpage-5;i<pages;i++)
{ %>
 <%if(i==currentpage){ %>
 <a href="<%=path %>/html/Land%20Slik%20Road.jsp?page=<%=currentpage%>" rel="external nofollow" rel="external nofollow" rel="external nofollow" rel="external nofollow" rel="external nofollow" rel="external nofollow" class="selected"><span><%=currentpage%></span></a>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            7
  <% }else{%>
 <a href="<%=path %>/html/Land%20Slik%20Road.jsp?page=<%=i%>"  rel="external nofollow" rel="external nofollow" rel="external nofollow" rel="external nofollow" rel="external nofollow" ><span><%=i%></span></a>
...
<%} %>
 ...
 <a href="<%=path %>/html/Land%20Slik%20Road.jsp?page=<%=currentpage%>" rel="external nofollow" rel="external nofollow" rel="external nofollow" rel="external nofollow" rel="external nofollow" rel="external nofollow" class="selected"><span><%=currentpage%></span></a>
<%while(currentpage<limitpage&&currentpage<pages-1){
	currentpage++;
 %>
   <a href="<%=path %>/html/Land%20Slik%20Road.jsp?page=<%=currentpage%>"  rel="external nofollow" rel="external nofollow" rel="external nofollow" rel="external nofollow" rel="external nofollow" ><span><%=currentpage%></span></a>
  <%
...
<%} %>  
  ...
  %> 
  <a href="<%=path %>/html/Land%20Slik%20Road.jsp?page=<%=tempcurrent+1 %>" rel="external nofollow" rel="external nofollow" rel="external nofollow" rel="external nofollow" rel="external nofollow" rel="external nofollow"  ><span>下一页</span></a>
   <%}%>
