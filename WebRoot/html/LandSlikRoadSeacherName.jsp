...
<div class="header">&nbsp;&nbsp;&nbsp;<a href="../index.jsp" target="_blank"><font color="bule">首页 </font></a>&nbsp;>&nbsp;探索&nbsp;>&nbsp;陆上文物</div>
</div>
...
<% ArrayList list= (ArrayList)session.getAttribute("mName");
int rows=list.size();
...
{
	t=(Integer.parseInt(curpage)-1)*9;
